 ...
 *
 */
public class NetPanelUDP extends NetPanel {

    final BridgeUDP udpBridge;
    
    /**
     * Creates new form NetPanelUDP
     */
    public NetPanelUDP(MultiBridge multiBridge, BridgeUDP udpBridge) {
        super(multiBridge, udpBridge);
    ...
    private void initComponents() {
        ...
        activeCheckbox.setText(String.format("UDP: %s", netBridge.getNetworkIdentifier()));
