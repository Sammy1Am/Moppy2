  ...
  while ((messagePos != 4 && Serial.available()) 
    ...
    switch (messagePos) {
      ...
      case 4:
		...
		// STM32 EDIT -recast to comply with STM32 handling of Serial.readBytes() which is not overloaded as in default Arduino code
        Serial.readBytes((char *)(messageBuffer + 4), messageBuffer[3]);
